...
namespace MemoryMap
{
    ...
    public static class Program
    {
        ...
        static string OutputStats(Dictionary<string, ValueEntry> dict, string header, StatType type)
        {
            int columnCount = 0;
            ...
            sbh.AppendLine("");
            return sbh.ToString() + sb.ToString() + "/n";
        ...
        public static string Parse(string memReportPath, string searchPattern, StatType type)
        {
            ...
            string output = "";
                foreach (var entry in allStats)
                {
                    ...
                    output += OutputStats(dict, key, type);
                }
